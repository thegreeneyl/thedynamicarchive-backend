...
namespace Drupal\workflow\Plugin\Filter;
 ...
 *
 * @Filter(
 *   id = "workflow_file_reference",
 *   title = @Translation("Workflow Track images uploaded via a Text Editor"),
      ...
      foreach ($xpath->query('//*[@data-entity-type="file" and @data-entity-uuid]') as $node) {
        ...
        if ($node->hasAttribute('src')) {
          ...
          if ($file instanceof FileInterface) {
            ...
            $file_url = \Drupal::request()->getSchemeAndHttpHost() . file_create_url($file_uri);
